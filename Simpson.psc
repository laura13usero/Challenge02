Algoritmo Simpson
		...
		Para ContadorHomer=1 Hasta 5 Con Paso 1 Hacer	//Establecer cordenadas aleatorias de Homer
			...
			Si tableroSimpsons[HomerX,HomerY] = "Homer" Entonces		//Si la casilla que ha salido está ocupada no se aplica y repetir proceso
				ContadorHomer = ContadorHomer-1
			SiNo
				tableroSimpsons[HomerX,HomerY] = "Homer"
			Fin Si
		Fin Para
		...
		Para ContadorBart=1 Hasta 1 Con Paso 1 Hacer	//Establecer cordenadas aleatorias de Homer
			BartX = Aleatorio(1,5)
			BartY = Aleatorio(1,5)
			Si tableroSimpsons[BartX,BartY] = "Vacio" Entonces		//Si la casilla que ha salido está ocupada no se aplica y repetir proceso
				tableroSimpsons[BartX,BartY] = "Bart"
			SiNo
